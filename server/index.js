...
const contractRouter = require('./routes/contract'); // :point_left: tvoje
const businessPartnerRouter = require('./routes/businessPartner');
const googleDriveAutoSync = require('./tasks/googleDriveAutoSync'); // :point_left: master
const googleDriveRouter = require('./routes/googleDrive'); // :point_left: master
...
app.listen(PORT, () => {
  console.log(`:large_green_circle: Server is running at port: ${PORT}`);
  setInterval(() => {

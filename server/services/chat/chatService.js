...
const { selectRelevantFiles } = require("../retrieval/fileSelector");
const { readFileFromRepo } = require("../integrations/readFileFromRepo");
...
async function ask(question) {
    try {
        ...
        const relevantFiles = await selectRelevantFiles(question, repoIndex);

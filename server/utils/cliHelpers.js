...
class CliHelpers {
    ...
    static showHelp() {
        console.log(`
KUF Bucket Processing Tool

USAGE:
  node tasks/processKufBucketFiles.js [OPTIONS]
...
EXAMPLES:
  node tasks/processKufBucketFiles.js --dry-run
  node tasks/processKufBucketFiles.js --max=5
  node tasks/processKufBucketFiles.js --verbose --include-data
  node tasks/processKufBucketFiles.js --force --max=3
  node tasks/processKufBucketFiles.js --reset-processing
  node tasks/processKufBucketFiles.js --health

...
export default function UploadButton({ onUploadSuccess, variant = "default", size = "default", className = "", disabled = false }) {
  ...
  return (
    <>
      <Button
        ...
        variant={variant}
        size={size}
        className={`group relative overflow-hidden transition-all duration-200 ${className} ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
